    ...
    <body>
        ...
        <section>
            <div>
                <h1>Categorías</h1>
                <br>
                <a href="UsuarioController?action=add" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Nuevo</a>
                ...
                <div class="main-content">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <th style="color: white; font-weight: bold; font-size: 20px;">Correo</th>
                        ...
                        <c:forEach var="item" items="${usuarios}">
                            <tr>
                                ...
                                <td style="color: black; font-weight: bold; font-size: 20px;">${item.correo}</td>

                                <td><a href="UsuarioController?action=edit&id=${item.id}"><i class="fas fa-edit"></i></a></td>
                                <td><a href="UsuarioController?action=delete&id=${item.id}" onclick="return(confirm('Esta seguro?'))">
