        ...
        <div class="container">
            ...
            <form action="OrdenController" method="post">
                    ...
                    <select name="producto_id" class="form-control">
                        ...
                        <c:forEach var="item" items="${lista_productos}">
                            <option value="${item.id}"
                                    <c:if test="${orden.producto_id == item.id}"> 
                                        selected
                                    </c:if> 
                                    >${item.nombre}</option>
                        </c:forEach>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cantidad" value="${orden.cantidad}" placeholder="Escriba la Cantidad">

                </div>
                <div class="form-group">
                    <label for="" class="form-label">Fecha</label>
                    <input type="date" class="form-control" name="fecha" value="${orden.fecha}" placeholder="Escriba la Fecha">
